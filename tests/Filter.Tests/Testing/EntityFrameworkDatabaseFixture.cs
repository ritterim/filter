...
namespace Filter.Tests.Testing
{
    ...
    /// </summary>
    public class EntityFrameworkDatabaseFixture : TestSqlClientDatabaseFixture
    {
        public EntityFrameworkDatabaseFixture() : base (
        ...
        {
            Console.WriteLine($"Creating {nameof(EntityFrameworkDatabaseFixture)} instance.");
            ...
            Console.WriteLine($"{nameof(EntityFrameworkDatabaseFixture)} instance created.");
        }
